                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Prostorije</div>
                            <div class="card-tools">
                            </div>
                        </div>
                        <b-table responsive hover :items="[prostorija]" :fields="fieldsProstorija">
                        </b-table>
                        <!-- /.card-header -->
                        <!-- /.card -->
                    </div>
        ...
        <b-tab title="Inventar">
            <div class="row mt-5">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title" v-if="prostorija.inventar && prostorija.inventar.length>0">Inventar koji sa nalazi u prostoriji "{{prostorija.naziv_prostorije}}"</div>
                            <div class="card-title" v-else>U prostoriji nema zabilježenih stavki inventara</div>
                            <div class="card-tools">
<!-- 
                        ...
                        <b-table  responsive hover :items="prostorija.inventar" :fields="fieldsInventar">
        ...
        methods: {
            ...
            loadProstorija(){
                console.log(this.$route.params.id);
                    axios.get('/api/prostorija/'+this.$route.params.id).then(({ data }) => (this.prostorija = data));
            },
