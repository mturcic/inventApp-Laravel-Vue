                ...
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title">Vrste</div>
                            <div class="card-tools">
                            </div>
                        </div>
                        <b-table responsive hover :items="[vrsta]" :fields="fieldsVrsta">
                        </b-table>
                        <!-- /.card-header -->
                        <!-- /.card -->
                    </div>
        ...
        <b-tab title="Inventar">
            <div class="row mt-5">
                <div class="col-md-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="card-title" v-if="vrsta.inventar && vrsta.inventar.length>0">Inventar koji sadrži vrstu "{{vrsta.naziv_vrste}}"</div>
                            <div class="card-title" v-else>U vrsti nema zabilježenih stavki inventara</div>
                            <div class="card-tools">
<!-- 
                        ...
                        <b-table  responsive hover :items="vrsta.inventar" :fields="fieldsInventar">
        ...
        methods: {
            ...
            loadVrsta(){
                console.log(this.$route.params.id);
                    axios.get('/api/vrsta/'+this.$route.params.id).then(({ data }) => (this.vrsta = data));
            },
